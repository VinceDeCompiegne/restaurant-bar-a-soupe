function lectureRecette(id_recette){
    ...
    xhr.open("GET", `/site/restaurant-bar-a-soupe/API/admin/detail_recette.php?id_recette=`+id_recette, true);
    xhr.send();
...
function callBackLecture(data){
    ...
    let span = document.createElement("div");
        ...
        string += '<tr>';
        string += '<td>Photo</td>';
        string += `<td><img class="pageAd__npt_rcp" name="nom" src="/site/restaurant-bar-a-soupe/assets/images/recette/${dataAJAX['image']}" style="max-height:75px;width:auto;"></img></td>`;
        string += '</tr>';
        string += '<tr>';
        string += '<td>Nom recette</td>';
        string += '<td><input type="textbox" class="pageAd__npt_rcp" name="nom" value="' + dataAJAX['nom'] + '"></td>';
        string += '</tr>';
        string += '<tr>';
        string += '<td>energy</td>';
        ...
        string += '<td><input type="textbox" class="pageAd__npt_rcp" name="fruit_percentage" value="' + dataAJAX['fruit_percentage'] + '"></td>';
        string += '</tr>';
        string += '<tr>';
        ...
        string += '<td><input type="textbox" class="pageAd__npt_rcp" name="saturated_fats" value="' + dataAJAX['saturated_fats'] + '"></td>';
        string += '</tr>';
        string += '<tr>';       
        string += '<td>sodium</td>';
        ...
        string += '<tr>';
        string += '<td>prix</td>';
        string += '<td><input type="textbox" class="pageAd__npt_rcp" name="prix" value="' + dataAJAX['prix'] + '"></td>';
        string += '</tr>';
        string += '<tr>';
        string += '<td>aime</td>';
...
function validMod(id){
    ...
    let image = e12.value;
     ...
     xhr.open("GET", `/site/restaurant-bar-a-soupe/API/admin/save_recette.php?id_recette=`+str_json, true);
     xhr.send();
...
let strSel = null;
xhr2.open("GET", `/site/restaurant-bar-a-soupe/API/admin/liste_image.php`, true);
xhr2.send();
