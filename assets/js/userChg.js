...
function fonctionAJAX() {
    ...
    xhr.open("POST", `/site/restaurant-bar-a-soupe/API/utilisateur/liste_utilisateur.php`, true);
    xhr.send();
...
function functionDelete(mail,type){
    ...
    xhr.open("GET", `/site/restaurant-bar-a-soupe/API/utilisateur/supp_utilisateur.php?`+str_json, true);
...
function functionInsert(){
    ...
    if(! strMail.match(validRegex)){
       ...
       var str_json = "compte=" + JSON.stringify([mail.value,actif.checked,type.value,password.value]);
        ...
        xhr.open("GET", `/site/restaurant-bar-a-soupe/API/utilisateur/insert_utilisateur.php?`+str_json, true);
        //Envoie les informations du header adaptées avec la requête
        xhr.send();
...
function checkActive(id,mail,type){
    ...
    var str_json = "compte=" + JSON.stringify([mail,actif.checked,type]);
        ...
        xhr.open("GET", `/site/restaurant-bar-a-soupe/API/utilisateur/active_utilisateur.php?`+str_json, true);
        //Envoie les informations du header adaptées avec la requête
        xhr.send();
