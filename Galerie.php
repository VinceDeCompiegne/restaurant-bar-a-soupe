          ...
          try {
            ...
            if ($qry->rowCount()!=0) {
                ...
                for($i=0;$i<$qry->rowCount();$i++){
                    ...
                    </div><img src="https://vincent-deramaux.hd.free.fr/restaurant-bar-a-soupe/assets/images/recette/'.$row['image'].'" alt="Photo Principal" style="max-height:400px;max-width:400px;height:100%;width:auto;margin-left:15%;"/>
                    <div class="plat">
                    <H4>'.$row['nom'].'</H4>
